...
Ebben a fejezetben kifejezetten azokat a kérdéseket vizsgálom, amelyeket a feladat kiemelt:
...
\subsection{PC2: asztali konfiguráció (integrált GPU)}

A PC2-n az x64 a natív és managed útvonalon látványosan gyorsabb,
...
A feladatban szereplő felvetés szerint az x64 gyorsabb lehet részben azért, mert az OpenCL kód
kompatibilitásból régebbi függvényeket használ x86-on. A \emph{mért adatok} alapján:
